    ...
    <div class="flex items-center justify-center min-h-screen">
        <div class="text-center">
            ...
            <form action="/handle_db/login.php" method="post">
                <input class="w-full p-2 border rounded" type="text" name="email" placeholder="Email">
                <input class="w-full p-2 border rounded" type="password" name="psswrd" placeholder="Password">
                <div class="pt-10">
